...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("contact-submit").addEventListener("click", function(e) {
      ...
      let contactSubject = document.getElementById("contact-subj").value;
      let contactMsg = document.getElementById("contact-msg").value;
    ...
    document.getElementById("contact-list").addEventListener("click", function(e) {
      if (e.target.classList.contains("update")) {
        ...
        let contactSubject = e.target.getAttribute("data-subj");
        ...
        document.getElementById("update-contact-subj").value = contactSubject;
    ...
    document.getElementById("update-contact-submit").addEventListener("click", function(e) {
      ...
      let contactSubject = document.getElementById("update-contact-subj").value;
      ...
      updateForm(contactId, contactEmail, contactName, contactSubject, contactMsg);
      });
  
    //[STEP 13]: Function that makes an AJAX call and processes it 
    // UPDATE Based on the ID chosen
    function updateForm(id, contactEmail, contactName, contactSubject, contactMsg) {
    ...
    var settings = {
      ...
      fetch(`https://interactivedev-5e86.restdb.io/rest/contact/${id}`, settings)
            .then(response => response.json())
            .then(data => {
              console.log(data);
              document.getElementById("update-contact-container").style.display = "none";
